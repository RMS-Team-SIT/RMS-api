...
export class PaymentController {
    ...
    async createPayment(
        ...
        return await this.paymentService.createPayment(residenceId, createResidencePaymentDto);
    }
    ...
    async getPayment(
        ...
        return await this.paymentService.findOnePaymentInResidence(residenceId, paymentId);
    }
    ...
    async updatePayment(
        ...
        return await this.paymentService.updatePaymentInResidence(residenceId, paymentId, updateResidencePaymentDto);
    }
