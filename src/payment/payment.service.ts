...
export class PaymentService {
    ...
    async createPayment(residenceId: string, createResidencePaymentDto: CreateResidencePaymentDto): Promise<Payment> {
        ...
        await this.residenceService.addPaymentToResidence(residenceId, createdPayment._id);
    ...
    async updatePaymentInResidence(residenceId: string, paymentId: string, updateResidencePaymentDto: UpdateResidencePaymentDto): Promise<Payment> {
        validateObjectIdFormat(residenceId, 'Residence');
        validateObjectIdFormat(paymentId, 'Payment');
